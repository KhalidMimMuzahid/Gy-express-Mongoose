...
router.get("/user/get_all_kyc", getAllKyc);
router.get("/user/get_single_kyc", getSingleKyc);
router.put("/user/update_kyc", updateKyc);
router.get("/user/get-all-reject-kyc", getAllRejectKyc);
router.get("/user/get-all-success-kyc", getAllSuccessKyc);
